...
class Bootstrap {
	 ...
	 * @return array
	 */
	public function _add_detail_url_field( $methods = array() ) {
		return array_merge(
			$methods,
			array(
	 ...
	 * @return array
	 */
	public function _add_sns_account_fields( $methods = array() ) {
	 ...
	 */
	public function _shortcode( $attributes = array() ) {
